package com.aditya.project.app.stack;

import com.aditya.project.ds.stack.ArrayStack;

public class CardArrayStackApp {

    ArrayStack<String> stack = new ArrayStack<>();

    public static void main(String[] args) {
        CardArrayStackApp app = new CardArrayStackApp();
        app.stackCards();
        app.unstackCards();
